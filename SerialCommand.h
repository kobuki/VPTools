...
#define SERIALCOMMAND_MAXCOMMANDS 10
...
class SerialCommand {
  ...
  private:
    ...
    SerialCommandCallback commandList[SERIALCOMMAND_MAXCOMMANDS];   // Actual definition for command/handler array
    byte commandCount;
	bool echo;
